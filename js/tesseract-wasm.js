/*!
 * tesseract-wasm v0.11.0 — ESM entry (vendored copy of dist/lib.js)
 * LICENSE: BSD-2-Clause — https://github.com/robertknight/tesseract-wasm
 * 本文件与 js/tesseract-worker.js 及根目录下的 tesseract-core*.wasm 配套使用。
 * 请勿修改，升级 tesseract-wasm 时请重新从 npm 包复制。
 */
/**
 * @license
